...
class Helpers {
	...
	public static function download_import_files( $import_file_info, $importtype ) {
		...
		if( $importtype == 1 ){
			...
			if ( file_exists( $import_file_info['local_import_template_homepage'] ) ) {
				$downloaded_files['content'] = $import_file_info['local_import_template_homepage'];
			}
		}elseif( $importtype == 4 ){
			if ( file_exists( $import_file_info['local_import_template_all_homepages'] ) ) {
				$downloaded_files['content'] = $import_file_info['local_import_template_all_homepages'];
			}
		}
