...
(function ($) {
	$(document).ready(function(){
		...
		$( '.resp-ajax-page-listing .page-listing-content .button-collapse' ).html( $('.resp-ajax-page-listing .page-listing-content ul.nav >li.active > a').html() );
		$(document).on( 'click', '.resp-ajax-page-listing .page-listing-content ul.nav >li', function(){
			$( '.resp-ajax-page-listing .page-listing-content .button-collapse' ).html( $('.resp-ajax-page-listing .page-listing-content ul.nav >li.active > a').html() );
		});
