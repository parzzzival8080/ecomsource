	...
	public function form( $instance ) {
		...
		<p>
			...
			<select class="widefat"
				...
				<option value="theme6-dokan" <?php if ($widget_template=='theme6-dokan'){?> selected="selected"
				<?php } ?>>
					<?php _e('Layout6', 'sw_vendor_slider')?>
				</option>
				<option value="theme7-dokan" <?php if ($widget_template=='theme7-dokan'){?> selected="selected"
				<?php } ?>>
					<?php _e('Layout7', 'sw_vendor_slider')?>
				</option>
				<option value="theme8-dokan" <?php if ($widget_template=='theme8-dokan'){?> selected="selected"
				<?php } ?>>
					<?php _e('Layout8', 'sw_vendor_slider')?>
				</option>
				<option value="tab-dokan" <?php if ($widget_template=='tab-dokan'){?> selected="selected"
				<?php } ?>>
					<?php _e('Tab Product', 'sw_vendor_slider')?>
				</option>	
			</select>
		</p>               
	<?php
