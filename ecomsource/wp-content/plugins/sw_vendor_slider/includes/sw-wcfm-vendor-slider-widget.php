	...
	public function form( $instance ) {
		...
		<p>
			...
			<select class="widefat"
				...
				<option value="theme6-wcfm" <?php if ($widget_template=='theme6-wcfm'){?> selected="selected"
				<?php } ?>>
					<?php _e('Layout6', 'sw_vendor_slider')?>
				</option>
				<option value="theme7-wcfm" <?php if ($widget_template=='theme7-wcfm'){?> selected="selected"
				<?php } ?>>
					<?php _e('Layout7', 'sw_vendor_slider')?>
				</option>
				<option value="theme8-wcfm" <?php if ($widget_template=='theme8-wcfm'){?> selected="selected"
				<?php } ?>>
					<?php _e('Layout8', 'sw_vendor_slider')?>
				</option>
				<option value="tab-wcfm" <?php if ($widget_template=='tab-wcfm'){?> selected="selected"
				<?php } ?>>
