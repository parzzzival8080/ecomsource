		...
		public function form( $instance ) {
			...
			<p>
				...
				<select class="widefat"
					...
					<option value="related2" <?php if ($widget_template=='related2'){?> selected="selected"
					<?php } ?>>
						<?php _e('Related Slider 2', 'sw_woocommerce')?>		
					</option>
					<option value="related-mobile" <?php if ($widget_template=='related-mobile'){?> selected="selected"
					<?php } ?>>
						<?php _e('Related Mobile', 'sw_woocommerce')?>		
					</option>					
					...
					<option value="vendor_related" <?php if ($widget_template=='vendor_related'){?> selected="selected"
					<?php } ?>>
						<?php _e('Related Products by vendor', 'sw_woocommerce')?>
					</option>					
				</select>
			</p>  
		<?php
