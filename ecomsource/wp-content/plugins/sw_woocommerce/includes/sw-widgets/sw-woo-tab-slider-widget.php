...
if ( !class_exists('sw_woo_tab_slider_widget') ) {
	class sw_woo_tab_slider_widget extends WP_Widget {
		...
		**/
		...
		function sw_tab_category_callback(){
			...
			$thumbnail_id      = ( isset( $_POST["thumbnail_id"] )  	&& $_POST["thumbnail_id"] != '' ) ? $_POST["thumbnail_id"] : 0;
			...
			$dots             = ( isset( $_POST["dots"] )  	&& $_POST["dots"] != '' ) ? $_POST["dots"] : 'false';
	...
	<?php 
		...
		?>
			...
			<?php elseif( $layout == 'theme12') :?>
			<div id="<?php echo esc_attr( 'tab_'. str_replace( '%', '', $target ) ); ?>" class="woo-tab-container-slider clearfix" data-lg="<?php echo esc_attr( $columns ); ?>" data-md="<?php echo esc_attr( $columns1 ); ?>" data-sm="<?php echo esc_attr( $columns2 ); ?>" data-xs="<?php echo esc_attr( $columns3 ); ?>" data-mobile="<?php echo esc_attr( $columns4 ); ?>" data-speed="<?php echo esc_attr( $speed ); ?>" data-scroll="<?php echo esc_attr( $scroll ); ?>" data-interval="<?php echo esc_attr( $interval ); ?>"  data-autoplay="<?php echo esc_attr( $autoplay ); ?>">
				<div class="resp-slider-container">
					<div class="slider">
						<!-- Product tab listing -->
						<?php 
	...
	<?php 
		...
		public function form( $instance ) {
			...
			<?php if ( $widget_template=='theme7' || $widget_template=='theme4' || $widget_template=='theme12' ){ ?>
			...
			<p>
				...
				<select class="widefat"
					...
					name="<?php echo $this->get_field_name('select_order').'[]'; ?>" multiple="multiple">
					<?php
					$option ='';
