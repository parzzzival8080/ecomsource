...
<div class="top-form top-form-minicart emarket-minicart2 pull-right">
	<div class="minicart-title pull-right">
		<h3><?php esc_html_e('My Cart','sw_woocommerce');?></h3>
		<p><?php echo '<span class="minicart-numbers">'.$woocommerce->cart->cart_contents_count.'</span>'; esc_html_e(' items', 'sw_woocommerce');?></p>
	</div>
	<div class="top-minicart-icon pull-right"></div>
	<div class="wrapp-minicart">
		<div class="minicart-padding">
			<div class="number-item"><?php echo esc_html__('There are ','sw_woocommerce').'<span class="item">' .$woocommerce->cart->cart_contents_count.' item(s)</span>'.esc_html__(' in your cart','sw_woocommerce');?></div>
