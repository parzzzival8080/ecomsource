...
<div class="top-form top-form-minicart emarket-minicart4 pull-right">
	<div class="top-minicart-icon pull-right">
		<a class="cart-contents" href="<?php echo wc_get_cart_url(); ?>" title="<?php esc_attr_e('View your shopping cart', 'sw_woocommerce'); ?>"><i class="fa fa-shopping-cart"></i><?php echo '<span class="minicart-number">'.$woocommerce->cart->cart_contents_count.'</span>';?>
