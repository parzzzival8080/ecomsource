...
<div class="top-form top-form-minicart emarket-minicart5 pull-right">
	<div class="top-minicart-icon pull-right">
		<div class="title-cart">
			...
			<a class="cart-contents" href="<?php echo wc_get_cart_url(); ?>" title="<?php esc_html_e('View your shopping cart', 'sw_woocommerce'); ?>"><?php echo '<span class="minicart-numbers">'.$woocommerce->cart->cart_contents_count.'</span>';  esc_html_e(' item(s)', 'sw_woocommerce');?> :  <?php echo $woocommerce->cart->get_cart_total(); ?></a>
		</div>
	</div>
