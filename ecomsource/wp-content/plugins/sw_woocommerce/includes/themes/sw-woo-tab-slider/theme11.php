...
<div class="sw-wootab-slider sw-ajax sw-woo-tab-<?php echo esc_attr( isset( $widget_template ) ? $widget_template : $layout );?>" id="<?php echo esc_attr( 'woo_tab_' . $widget_id ); ?>" >
	<div class="resp-tab" style="position:relative;">				
		<div class="category-slider-content">
			<div class="category-top-slider clearfix">
				<?php if( $title1 != '' ) { ?>
					<div class="box-title clearfix">
						<h3><span><?php echo ( $title1 != '' ) ? $title1 : ''; ?></span></h3>
						<a class="see-all" href="<?php echo esc_url( $viewall ); ?>" title="<?php esc_html_e( 'See all', 'sw_woocommerce' ) ?>"><?php echo esc_html__('See all','sw_woocommerce');?></a>
					</div>
					<?php } ?>
				<!-- Get child category -->
				<button class="navbar-toggle pull-right" type="button" data-toggle="collapse" data-target="#<?php echo 'nav_'.$widget_id; ?>"  aria-expanded="false">
					<span class="fa fa-bar"></span>
					<span class="fa fa-bar"></span>
					<span class="fa fa-bar"></span>
				</button>
				<div class="nav-tabs-select pull-right">
