<?php 
vc_add_shortcode_param( 'date', 'emarket_date_vc_setting' );

function emarket_date_vc_setting( $settings, $value ) {
...
vc_map( array(
	...
	'params' => array(
		...
		array(
			...
			'description' => sprintf( __( 'Select different style latest.', 'sw_woocommerce' ) )
			),
		array(
			"type" => "dropdown",
			"holder" => "div",
