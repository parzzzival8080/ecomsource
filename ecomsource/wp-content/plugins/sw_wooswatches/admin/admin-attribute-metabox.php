...
?>
		...
		<div class="form-field custom-picker">
			<label for="sw_variation_color2"><?php _e( 'Color 2', 'sw_woocommerce' ); ?></label>
			<input name="sw_variation_color2" id="sw_variation_color2" type="text" value="" size="40" class="category-colorpicker"/>
		</div>
	...
	**/
	public static function sw_woocommerce_edit_variation_fields( $term ) {
		...
		$sw_variation_color2 = get_term_meta( $term->term_id, 'sw_variation_color2', true );
	...
	?>
		...
		<tr class="form-field custom-picker custom-picker-edit">
			<th scope="row" valign="top"><label for="sw_variation_color2"><?php _e( 'Color 2', 'sw_woocommerce' ); ?></label></th>
			<td>
				<input name="sw_variation_color2" id="sw_variation_color2" type="text" value="<?php echo esc_attr( $sw_variation_color2 ) ?>" size="40" class="category-colorpicker"/>
			</td>
		</tr>
	...
	**/
	public static function sw_woocommerce_save_variation_fields( $term_id, $tt_id = '', $taxonomy = '', $prev_value = '' ) {
		...
		if ( isset( $_POST['sw_variation_color2'] ) ) {			
			$term_value = esc_attr( $_POST['sw_variation_color2'] );
			update_term_meta( $term_id, 'sw_variation_color2', $term_value, $prev_value );
		}
