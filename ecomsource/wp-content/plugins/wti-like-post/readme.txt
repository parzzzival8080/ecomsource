...
Donate link: https://paypal.me/webtechideas
...
A smooth ajax-based thumbs up/down functionality for wordpress posts/pages. PRO version is also available with wide range of features.
...
= PRO Features =
1. Functionality to restrict revoting based on IP address or user id or unique identifier. Please check [documentation](http://support.webtechideas.com/docs/wti-like-post-pro/description-and-features/) for more details.
2. Ability to change your vote when multiple voting is disabled.
3. Action hook available for successful voting so that you can attach any functionality like sending thank you mail to user. There are 2 other hooks available for further customizing the message you see on page load and ajax call.
4. Functionality for viewing like, unlike, total counts for individual post on admin Most Liked Posts screen. You can also view users who voted for each of them. This works only when logged in users are allowed to vote.
...
10. Functionality for showing the like/unlike buttons for manually added post excerpts.
...
17. In total 6 styles of buttons for like/unlike functionality. Hook available to add custom styles.
...
21. Functionality for setting starting like/unlike value when a post is created. You will see a section where you can set this value.
...
27. Functionality to show user avatars who liked the post.
28. myCRED points integration for liking and unliking posts.
29. Buddypress activity integration to show activity updates when a user likes and dislikes any content.

**PRO Plugin URL:** [https://www.webtechideas.in/product/wti-like-post-pro/](https://www.webtechideas.in/product/wti-like-post-pro/)

**PRO Plugin Demo:** [http://demowp.webtechideas.com/](http://demowp.webtechideas.com/)

**PRO Plugin Documentation:** [http://support.webtechideas.com/docs/wti-like-post-pro/description-and-features/](http://support.webtechideas.com/docs/wti-like-post-pro/description-and-features/)

**PRO Plugin Support Forum:** [http://support.webtechideas.com/forums/forum/wti-like-post-pro/](http://support.webtechideas.com/forums/forum/wti-like-post-pro/)
