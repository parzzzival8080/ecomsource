...
if( !function_exists( 'emarket_quickview' ) ){
...
?>
	<div class="pagination-ajax"><button class="button-ajax <?php echo esc_attr( ( $wp_query->max_num_pages == 1 ) ? 'loaded' : '' ) ?>" data-loadmore_style="<?php echo esc_attr( $loadmore_style ); ?>" data-maxpage="<?php echo esc_attr( $wp_query->max_num_pages ) ?>" data-title="<?php echo esc_attr__( 'Load More', 'emarket' ); ?>" data-loaded="<?php echo esc_attr__( 'All Item', 'emarket' ); ?>"></button></div>
<?php 
}
...
function emarket_before_shop_loop_wrapper_end()
{
    ...
    if (is_active_sidebar('above-product') && emarket_sidebar_product() == 'full' && $product_filter_style != 'accordion' ) {
        ?>
        <div class="sw-filter-above-shop <?php echo ( $product_filter_style == 'canvas' ) ? 'sticky-filter' : '';?>" id="sw_filter_full">
