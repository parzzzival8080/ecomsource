                    ...
                    <div class="col-md-12">
                        <div class="error-page text-center">
                            ...
                            <div class="error-body">
                                ...
                                <br>
                                <a href="<?php echo esc_url(home_url('/')) ?>" class="btn btn-primary solid blank"><i aria-hidden="true" class="xs xs-arrow-circle-left-solid"></i> <?php echo esc_html__('Go to Home', 'marketo') ?></a>
                            </div>
                        </div>
                    </div>
                </div>
