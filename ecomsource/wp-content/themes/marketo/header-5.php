            ...
            <div class="row">
                ...
                <div class="col-lg-6 d-none d-md-none d-lg-block">
                    <ul class="xs-header-info green-version">
                        <li><i class="xs xs-bus-solid"></i> <?php echo esc_html__('Track Your Order','marketo') ?></li>
                        <li><i class="xs xs-clock-regular"></i><?php echo esc_html__('24/7 Online Support','marketo') ?></li>
                    </ul>
                </div>
            </div>
        </div>
