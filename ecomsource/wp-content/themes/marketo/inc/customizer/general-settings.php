...
$fields[]	 = array(
	...
	'output'	 => array(
		array(
			'element'	 => '.xs-content-header.background-version, .xs-nav-tab .nav-link::before, .swiper-pagination .swiper-pagination-bullet-active,
		...
		array(
			'element'	 => '.product-block-slider .swiper-pagination .swiper-pagination-bullet-active',
			'property'	 => 'background-color',
		),
		array(
