...
class Xs_Icon_Controler extends Elementor\Base_Data_Control {
	...
	public static function get_icons() {
		...
		$icons = array(
            ...
            'xs xs-align-center-solid'    => 'xs xs-align-center-solid',
            'xs xs-align-justify-solid'   => 'xs xs-align-justify-solid',
            'xs xs-right-arrow'           => 'xs xs-right-arrow',
            'xs xs-angle-down-solid'      => 'xs xs-angle-down-solid',
            'xs xs-angle-right-solid'     => 'xs xs-angle-right-solid',
            'xs xs-apple-brands'          => 'xs xs-apple-brands',
            'xs xs-arrow-circle-left-solid'=> 'xs xs-arrow-circle-left-solid',
            'xs xs-balance-scale-solid'   => 'xs xs-balance-scale-solid',
            'xs xs-bars-solid'            => 'xs xs-bars-solid',
            'xs xs-behance-brands'        => 'xs xs-behance-brands',
            'xs xs-bitcoin-brands'        => 'xs xs-bitcoin-brands',
            'xs xs-blogger-brands'        => 'xs xs-blogger-brands',
            'xs xs-bolt-solid'            => 'xs xs-bolt-solid',
            'xs xs-bookmark-regular'            => 'xs xs-bookmark-regular',
            'xs xs-bus-solid'            => 'xs xs-bus-solid',
            'xs xs-camera-solid'            => 'xs xs-camera-solid',
            'xs xs-cannabis-solid'            => 'xs xs-cannabis-solid',
            'xs xs-carrot-solid'            => 'xs xs-carrot-solid',
            'xs xs-car-solid'            => 'xs xs-car-solid',
            'xs xs-cart-plus-solid'            => 'xs xs-cart-plus-solid',
            'xs xs-check-solid'            => 'xs xs-check-solid',
            'xs xs-chevron-left-solid'            => 'xs xs-chevron-left-solid',
            'xs xs-chevron-right-solid'            => 'xs xs-chevron-right-solid',
            'xs xs-clock-regular'            => 'xs xs-clock-regular',
            'xs xs-cloud-sun-rain-solid'            => 'xs xs-cloud-sun-rain-solid',
            'xs xs-comment-alt-regular'            => 'xs xs-comment-alt-regular',
            'xs xs-comments-solid'            => 'xs xs-comments-solid',
            'xs xs-credit-card-solid'            => 'xs xs-credit-card-solid',
            'xs xs-desktop-solid'            => 'xs xs-desktop-solid',
            'xs xs-dhl-brands'            => 'xs xs-dhl-brands',
            'xs xs-dribbble-square-brands'            => 'xs xs-dribbble-square-brands',
            'xs xs-dropbox-brands'            => 'xs xs-dropbox-brands',
            'xs xs-ebay-brands'            => 'xs xs-ebay-brands',
            'xs xs-ember-brands'            => 'xs xs-ember-brands',
            'xs xs-evernote-brands'            => 'xs xs-evernote-brands',
            'xs xs-eye-regular'            => 'xs xs-eye-regular',
            'xs xs-facebook-brands'            => 'xs xs-facebook-brands',
            'xs xs-facebook-f-brands'            => 'xs xs-facebook-f-brands',
            'xs xs-facebook-messenger-brands'            => 'xs xs-facebook-messenger-brands',
            'xs xs-fedex-brands'            => 'xs xs-fedex-brands',
            'xs xs-file-invoice-dollar-solid'            => 'xs xs-file-invoice-dollar-solid',
            'xs xs-flickr-brands'            => 'xs xs-flickr-brands',
            'xs xs-flipboard-brands'            => 'xs xs-flipboard-brands',
            'xs xs-folder-solid'            => 'xs xs-folder-solid',
            'xs xs-galactic-republic-brands'            => 'xs xs-galactic-republic-brands',
            'xs xs-gamepad-solid'            => 'xs xs-gamepad-solid',
            'xs xs-globe-europe-solid'            => 'xs xs-globe-europe-solid',
            'xs xs-google-pay-brands'            => 'xs xs-google-pay-brands',
            'xs xs-hard-hat-solid'            => 'xs xs-hard-hat-solid',
            'xs xs-headset-solid'            => 'xs xs-headset-solid',
            'xs xs-heart-regular'            => 'xs xs-heart-regular',
            'xs xs-heart-solid'            => 'xs xs-heart-solid',
            'xs xs-html5-brands'            => 'xs xs-html5-brands',
            'xs xs-infinity-solid'            => 'xs xs-infinity-solid',
            'xs xs-instagram-brands'            => 'xs xs-instagram-brands',
            'xs xs-internet-explorer-brands'            => 'xs xs-internet-explorer-brands',
            'xs xs-itunes-brands'            => 'xs xs-itunes-brands',
            'xs xs-keyboard-regular'            => 'xs xs-keyboard-regular',
            'xs xs-laptop-solid'            => 'xs xs-laptop-solid',
            'xs xs-left-arrow'            => 'xs xs-left-arrow',
            'xs xs-lightbulb-regular'            => 'xs xs-lightbulb-regular',
            'xs xs-line-brands'            => 'xs xs-line-brands',
            'xs xs-linkedin-in-brands'            => 'xs xs-linkedin-in-brands',
            'xs xs-list-ul-solid'            => 'xs xs-list-ul-solid',
            'xs xs-long-arrow-alt-left-solid'            => 'xs xs-long-arrow-alt-left-solid',
            'xs xs-long-arrow-alt-right-solid'            => 'xs xs-long-arrow-alt-right-solid',
            'xs xxs-magnet-solid'            => 'xs xxs-magnet-solid',
            'xs xs-map-marker-alt-solid'            => 'xs xs-map-marker-alt-solid',
            'xs xs-medium-brands'            => 'xs xs-medium-brands',
            'xs xs-microphone-solid'            => 'xs xs-microphone-solid',
            'xs xs-microsoft-brands'            => 'xs xs-microsoft-brands',
            'xs xs-mobile-alt-solid'            => 'xs xs-mobile-alt-solid',
            'xs xs-people-arrows-solid'            => 'xs xs-people-arrows-solid',
            'xs xs-pinterest-p-brands'            => 'xs xs-pinterest-p-brands',
            'xs xs-play-solid'            => 'xs xs-play-solid',
            'xs xs-playstation-brands'            => 'xs xs-playstation-brands',
            'xs xs-plug-solid'            => 'xs xs-plug-solid',
            'xs xs-podcast-solid'            => 'xs xs-podcast-solid',
            'xs xs-question-circle-solid-1'            => 'xs xs-question-circle-solid-1',
            'xs xs-question-circle-solid'            => 'xs xs-question-circle-solid',
            'xs xs-quote-right-solid'            => 'xs xs-quote-right-solid',
            'xs xs-random-solid'            => 'xs xs-random-solid',
            'xs xs-reddit-brands'            => 'xs xs-reddit-brands',
            'xs xs-reply-all-solid'            => 'xs xs-reply-all-solid',
            'xs xs-rich'            => 'xs xs-rich',
            'xs xs-right-arrow'            => 'xs xs-right-arrow',
            'xs xs-right-arrow-angle'            => 'xs xs-right-arrow-angle',
            'xs xs-rocket-solid'            => 'xs xs-rocket-solid',
            'xs xs-rss-solid'            => 'xs xs-rss-solid',
            'xs xs-safari-brands'            => 'xs xs-safari-brands',
            'xs xs-search-solid'            => 'xs xs-search-solid',
            'xs xs-shield-alt-solid'            => 'xs xs-shield-alt-solid',
            'xs xs-shopping-bag'            => 'xs xs-shopping-bag',
            'xs xs-shopping-bag-solid'            => 'xs xs-shopping-bag-solid',
            'xs xs-shopping-basket-solid'            => 'xs xs-shopping-basket-solid',
            'xs xs-shopping-cart'            => 'xs xs-shopping-cart',
            'xs xs-shopping-cart-basket'            => 'xs xs-shopping-cart-basket',
            'xs xs-shopping-cart-solid'            => 'xs xs-shopping-cart-solid',
            'xs xs-shuttle-van-solid'            => 'xs xs-shuttle-van-solid',
            'xs xs-sitemap-solid'            => 'xs xs-sitemap-solid',
            'xs xs-sketch-brands'            => 'xs xs-sketch-brands',
            'xs xs-skype-brands'            => 'xs xs-skype-brands',
            'xs xs-slack-brands'            => 'xs xs-slack-brands',
            'xs xs-smoking-solid'            => 'xs xs-smoking-solid',
            'xs xs-soundcloud-brands'            => 'xs xs-soundcloud-brands',
            'xs xs-spinner-solid'            => 'xs xs-spinner-solid',
            'xs xs-spotify-brands'            => 'xs xs-spotify-brands',
            'xs xs-star-solid'            => 'xs xs-star-solid',
            'xs xs-stripe-brands'            => 'xs xs-stripe-brands',
            'xs xs-team'            => 'xs xs-team',
            'xs xs-th-solid'            => 'xs xs-th-solid',
            'xs xs-thumbtack-solid'            => 'xs xs-thumbtack-solid',
            'xs xs-times-solid'            => 'xs xs-times-solid',
            'xs xs-tshirt-solid'            => 'xs xs-tshirt-solid',
            'xs xs-tumblr-brands'            => 'xs xs-tumblr-brands',
            'xs xs-twitch-brands'            => 'xs xs-twitch-brands',
            'xs xs-twitter-brands'            => 'xs xs-twitter-brands',
            'xs xs-uber-brands'            => 'xs xs-uber-brands',
            'xs xs-user-regular'            => 'xs xs-user-regular',
            'xs xs-user-solid'            => 'xs xs-user-solid',
            'xs xs-users-solid'            => 'xs xs-users-solid',
            'xs xs-venus-mars-solid'            => 'xs xs-venus-mars-solid',
            'xs xs-vimeo-brands'            => 'xs xs-vimeo-brands',
            'xs xs-volume-up-solid'            => 'xs xs-volume-up-solid',
            'xs xs-wikipedia-w-brands'            => 'xs xs-wikipedia-w-brands',
            'xs xs-wordpress-brands'            => 'xs xs-wordpress-brands',
            'xs xs-youtube-brands'            => 'xs xs-youtube-brands',
