<div class="xs-content-header">
    ...
    <div class="customNavigation xs-custom-nav">
        <div class="tab5-button-prev swiper-prev-<?php echo esc_attr($this->get_id()); ?>">
           <i class="xs xs-chevron-left-solid"></i>
       </div>
       <div class="tab5-button-next swiper-next-<?php echo esc_attr($this->get_id()); ?>">
           <i class="xs xs-chevron-right-solid"></i>
       </div>
    </div>
    <div class="clearfix"></div>
</div>
<div class="xs-product-slider-1 xs-product-slider-5 swiper" data-controls="<?php echo esc_attr($widgets_controls); ?>">
