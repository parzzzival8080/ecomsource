<div class="product-slider-style-1">
    <div class="xs-deal-of-the-day-section swiper bg-xs-primary">
        <div class="xs-slider-highlight swiper-wrapper">
            <?php
                ...
                while ($xs_query->have_posts()) :
                    ...
                    <div class="container swiper-slide">
                        <div class="row">
                            ...
                            <div class="col-md-6 align-self-center xs-best-deal-slider-content">
                                ...
                                <div class="xs-btn-wraper">
                                    <a href="<?php echo esc_url(get_the_permalink()); ?>" class="btn btn-outline-secondary icon-left btn-product-slider-1">
                                        <i class="xs xs-shopping-basket-solid"></i>
        ...
        <div class="swiper-button-prev">
            <i class="xs xs-left-arrow"></i>
        </div>
        <div class="swiper-button-next">
            <i class="xs xs-right-arrow"></i>
        </div>
