<?php if(is_array($sliders) && !empty($sliders)): ?>
    <div class="xs-banner swiper" >
        <div class="xs-banner-slider swiper-wrapper">
            <?php foreach($sliders as $slider): ?>
                ...
                ?>
                <div class="xs-banner-item swiper-slide" style="background-image:url(<?php echo esc_url($image); ?>)">
                    <div class="container">
                        <div class="row">
