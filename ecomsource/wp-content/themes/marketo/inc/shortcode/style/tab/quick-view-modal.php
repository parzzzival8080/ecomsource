<div class="woocommerce xs-modal xs-modal-quick-view xs-quick-view-modal-<?php echo esc_attr($rand_quick); ?> modal fade" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span class="xs xs-times-solid"></span>
            </button>
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
