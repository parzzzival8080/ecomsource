                ...
                <div class="row no-gutters">
                        ...
                        if($xs_query->have_posts()):
                            while ($xs_query->have_posts()) :
                                ...
                                ?>
                                <div class="col-lg-4 col-md-6 xs-deal-blocks deal-block-v2">
                                    ...
                                    <?php if($stock_available > 0) : ?>
                                        <!-- <div class="xs-deals-info"> -->
                                            ...
                                            <div class="progress xs-progress">
                                                <div class="progress-bar" role="progressbar" aria-label="progress bar" aria-valuenow="<?php echo esc_attr($percentage) ?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo esc_attr($percentage) ?>%;"></div>
                                            </div>
                                        <!-- </div> -->
                                    <hr>
                                    <?php endif; ?>
