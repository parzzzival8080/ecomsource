            ...
            <?php foreach ($product_tab as $key => $product_tabs): ?>
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo esc_attr($active) ?>" data-toggle="tab"
                       ...
                       ><?php echo esc_html($product_tabs['product_title']); ?></a>
                </li>
            <?php endforeach; ?>
        </ul>
    <?php endif; ?>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="xs-product-wraper version-3 text-center">
                                    ...
                                    <ul class="product-item-meta">
                                        ...
                                        <li><a href="#" data-toggle="modal" data-target=".xs-quick-view-modal-<?php echo esc_attr($rand_quick); ?>"><i class="xs xs-eye-regular"></i></a></li>
                                    ...
                                    <a class="product-title medium" href="<?php echo esc_url(get_the_permalink()) ?>"><?php echo get_the_title(); ?></a>
