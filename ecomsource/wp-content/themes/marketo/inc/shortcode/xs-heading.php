	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			'title_align', [
				...
				'default'		 => '',
                'selectors' => [
                    '{{WRAPPER}} .xs-heading-title' => 'text-align: {{VALUE}};',
                    '{{WRAPPER}} .xs-heading-sub' => 'text-align: {{VALUE}};',
                    '{{WRAPPER}} p.lead' => 'text-align: {{VALUE}};',
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(), [
                ...
                'selector'	 => '{{WRAPPER}} p.lead, {{WRAPPER}} .about-info p.lead',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px'],
                'selectors' => [
                    '{{WRAPPER}} p.lead' => 'margin-bottom: {{SIZE}}{{UNIT}};',
