		...
		*/
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .marketo-full-width-wraper-v2 h2' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .marketo-full-width-wraper-v2:hover h2' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .marketo-full-width-wraper-v2 h2',
			]
		);
		...
		*/
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .marketo-full-width-wraper-v2 p ' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .marketo-full-width-wraper-v2:hover p ' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label' =>esc_html__( 'Typography', 'marketo' ),
				'selector' => '{{WRAPPER}} .marketo-full-width-wraper-v2 p',
			]
		);
