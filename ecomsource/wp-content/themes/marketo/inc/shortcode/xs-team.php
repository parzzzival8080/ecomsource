            ...
            <div class="team-thumb">
                ...
                <div class="team-hover-content">
                    <ul class="xs-social-list">
                        <?php if(!empty($fb)): ?>
                            <li><a href="<?php echo esc_url($fb); ?>"><i class="xs xs-facebook-f-brands"></i></a></li>
                        <?php endif; ?>
                        <?php if(!empty($tw)): ?>
                            <li><a href="<?php echo esc_url($tw); ?>"><i class="xs xs-twitter-brands"></i></a></li>
                        <?php endif; ?>
                        <?php if(!empty($instagram)): ?>
                            <li><a href="<?php echo esc_url($instagram); ?>"><i class="xs xs-instagram-brands"></i></a></li>
                        <?php endif; ?>
