					...
					<ul class = "nav nav-tabs tab_menu_tiggers clearfix" id = "nav-tab" role = "tablist">
						<li class = "nav-item">
							<a class = "nav-link active" id = "nav-home-tab" data-toggle = "tab" href = "#nav-home" role = "tab"
							   aria-controls = "nav-home" aria-selected = "true"><i class = "xs xs-bars-solid"></i></a>
						</li>
						<li class = "nav-item">
							<a class = "nav-link" id = "nav-profile-tab" data-toggle = "tab" href = "#nav-profile" role = "tab"
							   aria-controls = "nav-profile" aria-selected = "false"><i class = "xs xs-user-solid"></i></a>
						</li>
					...
					<div class = "tab-content tab_menu_content" id="nav-tabContent">
						...
						<div class = "tab-pane fade" id = "nav-profile" role = "tabpanel" aria-labelledby = "nav-profile-tab">
							...
							<ul class = "tab_link_content">
								<li> <a href="<?php echo get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ); ?>" ><i class="xs xs-user-regular"></i> <?php echo esc_html__( 'My Account', 'marketo' ) ?></a></li>
								<li>
									<?php if ( class_exists( 'YITH_WCWL' ) ): ?>
										<a href="<?php echo esc_url( YITH_WCWL()->get_wishlist_url() ); ?>">
											<i class="xs xs-heart-regular"></i> <?php echo esc_html__( 'Wishlist', 'marketo' ) ?></a>
									<?php endif; ?></li>
								<?php
