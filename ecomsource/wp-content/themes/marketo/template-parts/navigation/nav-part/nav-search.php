...
if ($header_layout == '4') {
    ...
    <li>
        <div class="navSearch-group">
            <a href="#" class="navsearch-button"><i class="xs xs-search-solid"></i></a>
    ...
    <form class="<?php echo esc_attr($search_wrapper); ?>" action="<?php echo esc_url(home_url('/')); ?>" method="get"
        ...
        <div class="input-group">
            ...
            <div class="input-group-btn">
                ...
                <button type="submit" class="btn btn-primary" aria-label="Right Align"><i class="xs xs-search-solid"></i></button>
            </div>
        </div>
    </form>
